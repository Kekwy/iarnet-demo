...
@function(
    ...
    dependency=["datasets", "pandas", "modelscope"],
    provider="actor",
    name="read_data",
    venv="test2",
    cpu=1000,
...
@function(
    wrapper=ActorFunction,
    dependency=["datasets", "modelscope", "--index-url https://download.pytorch.org/whl/cpu torch", "peft", "transformers"],
    provider="actor",
    name="train",
    venv="test2",
    cpu=1000,
...
print("----first execute----")
data_dir = "/home/xhy/iarnet/ignis/clients/demo/eps_group"
